...
class CoordinatOffice(models.Model):
    title = models.CharField(max_length=20, null=True, blank=True)
    latoffice = models.FloatField(max_length=14, null=True, blank=True)
    longoffice = models.FloatField(max_length=14, null=True, blank=True)
    radius = models.FloatField(max_length=4,default=10.0, null=True, blank=True)
    reminder_time1 = models.IntegerField(default=7,null=True, blank=True)
    reminder_time2 = models.IntegerField(default=7,null=True, blank=True)
    def __str__(self):
        return self.title

class CoordinatUser(models.Model):
    nik = models.CharField(max_length=6)
    name = models.CharField(max_length=50,null=True, blank=True,)
    lat = models.FloatField(max_length=14, null=True, blank=True,)
    long = models.FloatField(max_length=14, null=True, blank=True,)
    radius = models.FloatField(max_length=4,default=50.0, null=True, blank=True)
    lat2 = models.FloatField(max_length=14, null=True, blank=True,)
    long2 = models.FloatField(max_length=14, null=True, blank=True,)
    radius2 = models.FloatField(max_length=4,default=50.0, null=True, blank=True)
    address = models.CharField(max_length=500, null=True, blank=True,)
    office1 = models.ForeignKey("api.CoordinatOffice", on_delete=models.CASCADE, null=True, blank=True, related_name='office1')
    office2 = models.ForeignKey("api.CoordinatOffice", on_delete=models.CASCADE, null=True, blank=True, related_name='office2')
    office3 = models.ForeignKey("api.CoordinatOffice", on_delete=models.CASCADE, null=True, blank=True, related_name='office3')
    office4 = models.ForeignKey("api.CoordinatOffice", on_delete=models.CASCADE, null=True, blank=True, related_name='office4')
    office5 = models.ForeignKey("api.CoordinatOffice", on_delete=models.CASCADE, null=True, blank=True, related_name='office5')
    office6 = models.ForeignKey("api.CoordinatOffice", on_delete=models.CASCADE, null=True, blank=True, related_name='office6')
...
class WorkTime(models.Model):
    ...
    data_emp = models.ForeignKey(MasterEmployee,on_delete=models.CASCADE, blank=True, null=True)
    

    def __str__(self):
        return self.nik

class WorkTasklist(models.Model):
    nik = models.CharField(max_length=6)
    name = models.CharField(max_length=50,null=True, blank=True,)
    task = models.TextField()
    isfinish = models.BooleanField()
    create_task = models.TimeField(max_length=12,blank= True,null=True)
    date = models.DateField(max_length=12,blank= True,null=True)
    data_emp = models.ForeignKey(MasterEmployee,on_delete=models.CASCADE, blank=True, null=True)
...
# def Time_create_clock_in_cloc_out(sender, instance, created,**kwargs):
#     nik = instance.nik
#     date = instance.date
#     time_in = instance.time
#     if created:
#         TimeView.objects.get_or_create(nik=nik, date=date, time_in=time_in)
...
class BulletinGrpGoogleReview(models.Model):
    id = models.BigAutoField(primary_key=True)
    google_place_id = models.IntegerField()
...
date_time_str = "1999-01-01 00:00:00.0000"
...
class Leaveheader(models.Model):
    ...
    wk_type = models.CharField(max_length=3)
    in_time = models.TimeField(null=True, blank=True, default="00:00:00.000000")
    out_time = models.TimeField(null=True, blank=True, default="00:00:00.000000")
    loss_time = models.IntegerField(blank=True, null=True, default=0)
    plan_in = models.TimeField(null=True, blank=True, default="00:00:00.000000")
    plan_out = models.TimeField(null=True, blank=True, default="00:00:00.000000")
    term_days = models.IntegerField(blank=True, null=True)
    reason = models.TextField(blank=True, null=True)
    destination = models.CharField(max_length=50)
    contact = models.CharField(max_length=20)
    crt_dt = models.DateField(blank=True, null=True, auto_now_add=True,)
    upd_dt = models.DateField(blank=True, null=True, auto_now_add=True,)
    ...
    sendapp1_sts = models.CharField(max_length=3,default="NON")
    sendapp1_dt = models.DateTimeField(null=True, blank=True, default=None)
    sendapp2_sts = models.CharField(max_length=3,default="NON")
    sendapp2_dt = models.DateTimeField(null=True, blank=True, default=None)
    sendapp3_sts = models.CharField(max_length=3,default="NON")
    sendapp3_dt = models.DateTimeField(null=True, blank=True, default=None)
    sendemp_sts = models.CharField(max_length=3,default="NON")
    act_term = models.IntegerField(blank=True, null=True, default=0)
    act_state1 = models.CharField(max_length=3,default="NON")
    act_comment1 = models.CharField(max_length=255, blank=True, null=True)
    act_date1 = models.DateTimeField(null=True, blank=True, default=None)
    act_state2 = models.CharField(max_length=3,default="NON")
    act_comment2 = models.CharField(max_length=255, blank=True, null=True)
    act_date2 = models.DateTimeField(null=True, blank=True, default=None)
    act_state3 = models.CharField(max_length=3,default="NON")
    act_comment3 = models.CharField(max_length=255, blank=True, null=True)
    act_date3 = models.DateTimeField(null=True, blank=True, default=None)
    attachment = models.CharField(max_length=50)
    doc_support = models.CharField(max_length=3, default="NON")
    acc_step = models.IntegerField(blank=True, null=True, default=0)
...
class MasterDepartment(models.Model):
    ...
    division_id = models.CharField(max_length=1)
...
class WorkingcalendarCreate(models.Model):
    arriv_time = models.TimeField()
    out_time = models.TimeField()
    group_id = models.CharField(max_length=4, choices=group)
    yyyy = models.CharField(max_length=4)
...
@receiver(post_save, sender=WorkingcalendarCreate)
def Logbook_detail_post_save(sender, instance, created,*args, **kwargs):
    ...
    if created :
            for single_date in daterange(start_date, end_date):
                date_field = single_date.strftime('%Y%m%d')
                print(date_field)
                day = single_date.strftime('%A')
                wk_des = single_date.strftime('%B')
                thisday = day
                if thisday == "Saturday":
                    thisday = "P"
                elif thisday == "Sunday":
                    ...
                    thisday = "K"
                Workingcalendar.objects.get_or_create(wk_day=date_field,
                group_id=group,arriv_time=instance.arriv_time, out_time=instance.out_time,wk_type=thisday,yyyy=instance.yyyy, dy_name=day,
                user_id=instance.user_id,wk_desc=wk_des, crt_dt=datenow, upd_dt=datenow
